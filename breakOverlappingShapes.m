...
% 				[newshapes{i}(2,:),fliplr(shapes{uncontained(j)}(2,:)),shapes{uncontained(j)}(2,end),newshapes{i}(2,end)]];
			newshapes{i} = [[newshapes{i}(1,:),newshapes{i}(1,1),fliplr(shapes{uncontained(j)}(1,:)),shapes{uncontained(j)}(1,end),newshapes{i}(1,1)];...
				[newshapes{i}(2,:),newshapes{i}(2,1),fliplr(shapes{uncontained(j)}(2,:)),shapes{uncontained(j)}(2,end),newshapes{i}(2,1)]];
